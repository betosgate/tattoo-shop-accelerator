  ...
  return (
    <Section id="pricing">
      <FadeUp>
        <SectionHeader
          badge="Pricing"
          title="Invest in Your Studio's Future"
          description="No long-term contracts. No hidden fees. Just a platform that pays for itself in new bookings."
        />
      </FadeUp>
      ...
      <FadeUp delay={0.3}>
        <p className="text-center text-sm text-ink-500 mt-8">
          All plans include hosting, SSL, maintenance, and technical support.{" "}
