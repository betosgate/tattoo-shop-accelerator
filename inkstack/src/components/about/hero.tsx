      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-white">
            ...
            <span className="gradient-text">Owns a Tattoo Shop</span>
          </h1>
          <p className="mt-6 text-lg text-ink-300 max-w-2xl mx-auto">
            This isn&apos;t some Silicon Valley startup that thinks they understand your business.
            Tattoo Shop Accelerator was built from inside the industry, by someone who runs one.
          </p>
        </motion.div>
      </div>
    </section>
